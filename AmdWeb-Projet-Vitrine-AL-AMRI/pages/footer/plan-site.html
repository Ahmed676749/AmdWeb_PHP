...
<html lang="fr-FR">
  <head>
    ...
    <title>AmdWeb, offres d'emplois, plan du site</title>
  </head>
  <body>
    <div class="wrapper-plan">
          ...
          <div class="container-fluid">
            ...
            <nav class="collapse navbar-collapse color-style" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../job/emploi.html">Emploi</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="../photos/galerie.html">Galerie</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="../enregistrement/inscription.html"
                    >Inscription</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="../depots/connexion.html"
                    >Connexion</a
                  >
                </li>
              </ul>
      ...
      <main>
        ...
        <div class="wrapper-list">
          ...
          <ul>
            <li>
              <a href="../../index.html" class="welcome">Accueil</a>
            </li>
            <li>
              <a href="../job/emploi.html">Emploi</a>
            </li>
            <li>
              <a href="../job/details-emploi.html" class="details"
                >Détails de l'offre d'emploi</a
              >
            </li>
            <li>
              <a href="../enregistrement/inscription.html">Inscription</a>
            </li>
            <li>
              <a href="../depots/connexion.html">Connexion</a>
            </li>
            <li>
              <a href="../photos/galerie.html">Galerie</a>
            </li>
            <li>
              <a href="../footer/mentions.html">Mentions légales</a>
            </li>
            <li>
