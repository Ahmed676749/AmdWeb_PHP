...
<html lang="fr-FR">
  <head>
    ...
    <title>AmdWeb offres d'emplois, galerie photos</title>
  </head>
      ...
      <header class="color-style">
        <div class="navbar navbar-expand-lg">
          <div class="container-fluid">
            ...
            <nav
              class="collapse navbar-collapse color-style nav-gallery"
              id="navbarNav"
            >
              <ul class="navbar-nav">
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="../photos/galerie.html"
                    >Galerie</a
                  >
                </li>
                <li class="nav-item">
