...
<html lang="fr-FR">
  <head>
    ...
    <title>AmdWeb offres d'emplois, connexion</title>
  </head>
  <body>
    <div class="wrapper">
      <!--Header navigation-->
          ...
          <div class="container-fluid">
            ...
            <nav class="collapse navbar-collapse color-style" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="../depots/connexion.html"
                    >Connexion</a
                  >
                </li>
              </ul>
        ...
        <section>
          <div class="wrapper-subscribe">
            ...
            <p class="text-presentation">
              ...
              <a href="../enregistrement/inscription.html"> Inscrivez-vous!</a>
            </p>
            <div class="style">
      ...
      <footer>
        <div class="wrap-footer">
          ...
          <div class="nav-footer">
            <a href="../footer/plan-site.html">Plan du site</a>
