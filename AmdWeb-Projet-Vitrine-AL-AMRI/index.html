...
<head>
  ...
  <title>AmdWeb, offres d'emplois spécialisé web</title>
</head>
          ...
          <div class="container-fluid">
            ...
            <nav class="collapse navbar-collapse color-style" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="pages/job/emploi.html">Emploi</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/photos/galerie.html">Galerie</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/enregistrement/inscription.html">Inscription</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/depots/connexion.html">Connexion</a>
                </li>
              </ul>
            </nav>
          </div>
    ...
    <section class="presentation-section">
      ...
      <div class="text-presentation">
        ...
        <p>
          ...
          mon site, <a href="index.html">AmdWeb</a> en alternative à votre
          recherche d'emplois.
          <br />
    ...
    <div class="wrap-section">
      <div class="inscription-section">
        ...
        <div class="btn-link-wrap style-button">
          <a href="pages/enregistrement/inscription.html"> Inscription </a>
        </div>
      </div>
      <div class="announcement-section">
        <h2 class="style-h">Déposer vos offres d'emplois.</h2>
        <div class="btn-link-wrap style-button">
          <a href="pages/depots/connexion.html">Déposez</a>
        </div>
      </div>
    </div>
    <!--Footer-->
    <footer>
      <div class="wrap-footer">
        ...
        <div class="nav-footer">
          <a href="pages/footer/plan-site.html">Plan du site</a>
          <a href="pages/footer/mentions.html">Mentions légales</a>
        </div>
      </div>
      <div class="wrap-map">
